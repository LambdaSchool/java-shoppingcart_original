...
@Configuration
/*this is the primary spring security annotation that is used to
enable web security in a project*/
@EnableWebSecurity
/*This is used to enable method level security based on annotations.
 You can use following three types of annotations for securing your
 methods -*/
@EnableGlobalMethodSecurity(
        securedEnabled = true, // enables @Secured annotation using which you can protect your controller/service
